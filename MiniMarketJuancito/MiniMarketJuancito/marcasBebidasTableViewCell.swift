//
//  marcasBebidasTableViewCell.swift
//  MiniMarketJuancito
//
...
class marcasBebidasTableViewCell: UITableViewCell {
    ...
    func configureMarcaBebidas(viewList: BebidaResponse?) {
        ...
        let urlLogoBebida = list.logo
        if let url = URL(string: urlLogoBebida) {
