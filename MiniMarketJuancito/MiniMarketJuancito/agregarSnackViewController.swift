...
class agregarSnackViewController: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func guardarProducto() {
        ...
        guard let entityProducto = NSEntityDescription.insertNewObject(forEntityName: "Snack", into: context) as? Snack else {
